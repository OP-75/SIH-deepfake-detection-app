...
def upload_media():
    ...
    if is_face_detected:
        ...
        video_dataset = validation_dataset(filepath, sequence_length=60, transform=train_transforms)
        path_to_model = 'model_90_acc_60_frames_final_data.pt'
